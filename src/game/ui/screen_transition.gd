...
var transition_dictionary = {
	TransitionType.NONE : {
		"animation_name": "",
		"scene_transition_frame": 0
	},
	TransitionType.BATTLE_START : {
		"animation_name": "battle_start",
		"scene_transition_frame": 25
	},
	TransitionType.BATTLE_WON : {
		"animation_name": "battle_victory",
		"scene_transition_frame": 27
	},
	TransitionType.BATTLE_LOST : {
		"animation_name": "battle_defeat",
		"scene_transition_frame": 25
	}
}
...
func _physics_process(delta):
	...
	if animated_sprite_2d.frame == transition_dictionary[current_transition]["scene_transition_frame"]:
